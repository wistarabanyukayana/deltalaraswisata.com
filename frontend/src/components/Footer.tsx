...
export default function Footer() {
  return (
    <footer id="footer">
      <div
        id="footer-top"
        className="flex w-full items-center justify-center bg-zinc-800 px-[12px] py-[85px] text-zinc-50"
      >
        <div className="flex w-5xl flex-col justify-around gap-7 sm:flex-row">
          <div className="mb-[35px] flex flex-col sm:mb-0">
          ...
          <div className="mb-[35px] flex w-fit flex-col sm:mb-0">
            <h3 className="font-merriweather-sans mb-[25px] text-start text-xl font-semibold text-nowrap lg:mb-[35px] lg:text-3xl">
              Hubungi Kami
            </h3>
            <p className="flex flex-col items-start justify-around gap-2 text-justify text-sm text-zinc-200 lg:text-base">
              ...
              >
                <SiWhatsapp className="inline-block" /> 088222122250
              </a>
              ...
              >
                <Phone className="inline-block" /> 088222122250
              </a>
              <a
                className="flex flex-row items-center gap-2 transition-opacity hover:opacity-80"
                href="mailto:business@dallastourtravel.com"
              >
                <Mail className="inline-block" /> business@dallastourtravel.com
              </a>
              <a
                className="transition-opacity hover:opacity-80"
                href="https://g.co/kgs/gaJF2zi"
              >
                <MapPin className="inline-block" /> Jl. Raya Kalibata No.25,
                RT.11/RW.5, Cawang, Kec. Kramat jati, Kota Jakarta Timur, Daerah
